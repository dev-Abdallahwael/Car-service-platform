...
if(isset($_SESSION['user_id'])&& isset($_GET['id'])){
  ...
  if (mysqli_num_rows($runQueryUser)==1) {
    $user  = mysqli_fetch_assoc($runQueryUser);
    $_SESSION['get_user'] = "center found";
  }else{
    $_SESSION['get_user'] = "center not found";
  }
}else{
        ...
        <form class="w-75 container " action="handle/addingCenterHandle.php" method="post" enctype="multipart/form-data">
            ...
            <div class="DisplayData py-3">
              <div class="row g-3">
                  ...
                  <div class="col-12 col-lg-5 shadow-lg bg-white rounded-3 me-2">
                    <div class="">
                      ...
                      <div class="btns ms-5 py-3">
                        <a href="appointment-form.php?id=<?php echo $center['id']?>" class="btn btn-outline-warning fw-bold" id="Edit" style="margin-right: 9rem;" >Book a date</a>
                      </div>
                    </div>
                  </div>
                  <?php //endforeach; ?>
                ...
                <!-- <div class="col-12 col-lg-5 shadow-lg bg-white rounded-3 me-2">
                  <div class="">
                    <img src="../imgs/viewcars.jpg" alt="Center photo" class="w-100">
                    <div class="cardcontent">
                      <ul class="fw-bold text-capitalize text-center">Center Name</ul>
                      <ul>Center owner</ul>
                      <ul>Phone number</ul>
                      <ul>Service provided</ul>
                      <ul>Desipcrtion</ul>
                      <ul>Location url</ul>
                    </div>
                    <div class="btns ms-5 py-3">
                      <button type="button" class="btn btn-outline-warning fw-bold" id="Edit" style="margin-right: 9rem;">Edit</button>
                      <button type="button" class="btn btn-outline-danger fw-bold" id="del">Delete</button>
                    </div>
                  </div>
                </div>                   
              </div>
