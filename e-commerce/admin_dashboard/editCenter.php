...
if(isset($_GET['id'])){
  ...
  $query = "SELECT users.name, centers.* FROM centers JOIN users ON users.id = centers.owner_id WHERE centers.owner_id = '$owner_id' and centers.id = '$postId' ";
...
<!--=============> Inputs form =================-->
        <form class="w-75 container " action="handle/editCenterHandle.php?id=<?php echo $center['id'] ?>" method="post" enctype="multipart/form-data">
            <div class="form-floating mb-3">
              <input type="hidden" name="id" id="" value="<?php echo $center['id'] ?>">
              <input
                type="text"
            ...
            <div class="form-floating mb-3">
              <textarea
                ...
                name="descr"
              ><?php echo $center['descr']; ?></textarea>
            ...
            <div class="form-floating mb-3">
              <input
                ...
                autocomplete="off"
                name="location"
                value="<?php echo $center['location']; ?>"
              />
            ...
            <button class="btn btn-primary" id="addBtn" type="submit" name="submit" >
              edit 
            </button>
            <button class="btn btn-info d-none" id="updateBtn" type="button" >
              Update 
            </button>
                  ...
                  <div class="col-12 col-lg-5 shadow-lg bg-white rounded-3 me-2">
                    <div class="">
                      ...
                      <!-- <div class="btns ms-5 py-3">
                        <button type="button" class="btn btn-outline-warning fw-bold" id="Edit" style="margin-right: 9rem;" value="<?php echo $center['id']; ?>" >Edit</button>
                        <button type="button" class="btn btn-outline-danger fw-bold" id="del" value="<?php echo $center['id']; ?>" >Delete</button>
                      </div> -->
                    </div>
                  </div>
                  <?php //endforeach; ?>
