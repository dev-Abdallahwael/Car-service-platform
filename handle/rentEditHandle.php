...
if(isset($_POST['submit'])){
    ...
    $id = $_GET['id'];
    $querySelect = "select front_image,back_image,Interior_image,side_image from rent_cars where id = $id ";
    ...
    if($errors < 1){
       $query =" UPDATE rent_cars
        ...
        if($runQuery){
            ...
            $_SESSION['rentCarEdit'] = "car edit success";
            header("location:../Rent_Car.php");
            exit();
        }else{
            $_SESSION['rentCarEdit'] = "car edit failed";
            header("location:../Rent_Car.php");
            exit();
        }

    }else{
        $_SESSION['rentCarEdit'] = "car edit error $error";
        header("location:../Rent_Car.php");
        exit();
    }
