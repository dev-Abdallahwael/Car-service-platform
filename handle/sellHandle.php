...
if(isset($_SESSION['user_id'])){
    ...
    if($errors < 1){
        ...
        $query = "INSERT INTO sell_cars(`car_model`,`city`,`year_of_manufacture`,`Mielage`,`Price`,`Additional_Notes`,`user_phone`,`user_id`,`front_image`,`back_image`,`Interior_image`,`side_image`)
        ...
        if($runQuery){
            ...
            $_SESSION['sellCar'] = "car added successfuly";
            header("location:../Sell_Car.php");
            exit();
        }else{
            $_SESSION['sellCar'] = "car added failed";
            header("location:../Sell_Car.php");
            exit();
        }

    }else{
        $_SESSION['sellCar'] = "center added error $error";
        header("location:../Sell_Car.php");
        exit();
    }
