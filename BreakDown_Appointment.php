...
<?php endif; ?>
        ...
        <div class="appointment-form mt-5 pt-5 container">
            ...
            Book your <span class="text-danger">Breakdown </span> Assistance.
            </h2>
        <form id="appointmentForm" action="handle/breakDownAppointmentHandle.php?id=<?php echo $centerId; ?>" method="post">
                <div class="row">   
                    ...
                    <div class="secRight col-12 col-lg-6 ">
                        <div class="form-group">
                            ...
                            <select id="service" name="service"  class="form-control" required>
                                ...
                                <option value="Brakes issue">Brakes issue</option>
                                <option value="Running out of gas">Running out of gas</option>
                        ...
                        <div class="LocBtn">
                        <button type="button" onclick="getLocation()" class="btn btn-danger mt-2">Get My Location</button>
                          <div>
                              <textarea id="location-status" name="location" rows="3"></textarea>  
                          </div>
                        </div>                                
                    </div>
