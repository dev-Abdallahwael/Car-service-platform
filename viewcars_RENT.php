...
$query = "SELECT rent_cars.*, users.name, users.email
FROM rent_cars
...
if(mysqli_num_rows($runQuery)>0){
  ...
  $_SESSION['rentCars'] = "cars found";
}else{
  $_SESSION['rentCars'] = "no cars found";
}


echo $_SESSION['rentCars'];
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <span class="text-danger">Rent</span> a car.
      </h2>
        ...
        <div class="col car" id="car" >
             <div class="card h-100 border-0 shadow-lg border-0 px-3 py-2">
              <div class="card-body">
                 ...
                 <h5 class="card-title text-uppercase my-3 fs-5 text-capitalize bold-headers text-center text-secondary"> Price per day : <strong class="text-black"> <?php echo $car['Price_per_day']; ?></strong> </h5>
                 <div class="card-text fw-bolder">
                    ...
                    <a href="rentCarView.php?id=<?php echo $car['id']?>" class="btn btn-outline-warning fw-bold" id="Edit" style="margin-right: 9rem;" >view center</a>
                  </div>
                 </div>
             </div>
            </div>
