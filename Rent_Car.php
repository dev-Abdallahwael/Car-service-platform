...
if(isset($_SESSION['user_id'])){
    ...
    $cars = [];
    $query = $query = "SELECT rent_cars.*, users.name, users.email
    FROM rent_cars
    INNER JOIN users ON rent_cars.user_id = users.id
    WHERE rent_cars.user_id = $userId";
    ...
    <nav class="navbar fixed-top bg-black navbar-expand-lg">
      <div class="container">
        ...
        <div class="appointment-form mt-5 pt-5 container">
            ...
            <span class="text-danger">Rent </span>your car.
            </h2>
            <h1>
            <?php
                    if(isset($_SESSION['rentCarEdit'])){
                        echo $_SESSION['rentCarEdit'];
                        unset($_SESSION['rentCarEdit']);
                    }
                
                ?>
            </h1>
            <!-- form -->
        <form id="appointmentForm" action="handle/rentHandle.php" method="post" enctype="multipart/form-data">
                <div class="row">   
            ...
            <div class="col" id="CarMaintCenter" >
                 <div class="card h-100 border-0 shadow-lg border-0 px-3 py-2">
                  <div class="card-body">
                     ...
                     <h5 class="card-title text-uppercase my-3 fs-5 text-capitalize bold-headers text-center text-secondary"> Price per day : <strong class="text-black"> <?php echo $car['Price_per_day'] ?> egp </strong> </h5>
                     <div class="card-text fw-bolder">
                        ...
                        <div class="btns d-flex justify-content-around">
                            <a href="Rent_CarEdit.php?id=<?php echo $car['id'] ?>"><button class="btn btn-primary">Edit</button></a>
                            <a href="handle/rentDelete.php?id=<?php echo $car['id'] ?>"><button class="btn btn-danger">Delete</button></a>
