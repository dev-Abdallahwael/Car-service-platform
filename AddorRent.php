              ...
              <div class="row row-cols-1 row-cols-lg-3 g-5 ">
                <div class="col ">
                    <div class="d-flex justify-content-center pt-lg-5 mt-lg-5 mt-sm-0">
                        <h1 class="viewcarsHeader bold-headers ">Sell & Rent <br><span class="text-danger">Cars</span></h1>
                    </div>
                    ...
                    <div class="viewbtns d-flex mt-5 mx-1">
                        <a href="Rent_Car.php"><button class="btn Rent border-black me-1">Rent your car</button></a>
                       <a href="Sell_Car.php"> <button class="btn Sell border-black">Sell your car</button></a>
                    </div>
                </div>
                <div class="col">
