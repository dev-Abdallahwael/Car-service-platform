    ...
    <form id="appointmentForm">
            <div class="row">   
                ...
                <!-- <div class="form-group">
                    ...
                    <input type="text" id="Phone" name="Phone" value="Put Phone here" readonly class="form-control border-black">
                </div>
                </div> -->
                ...
                <!-- <div class="secRight col-12 col-lg-6 ">
                    <div class="form-group">
                        ...
                        <input type="text" id="Lastname" name="Lastname" value="Put Lastname here" readonly class="form-control  border-black">
                     </div> -->

                     <!-- <div class="form-group">
                        <label for="Lastname">Car Model </label>
                        <input type="text" id="Car Model" name="Car Model" class="form-control" placeholder="Enter Your Car Model">
                     </div> -->

                     <!-- <div class="form-group">
                        <label for="Car manufacture year">Car manufacture year </label>
                        <input type="text" id="Car manufacture year" name="Car manufacture year" class="form-control" placeholder="Enter Your Car manufacture Year">
                     </div> -->
                </div>
                ...
                <div class="form-group d-flex justify-content-evenly py-5">
                    ...
                    <!-- From Uiverse.io by adamgiebl --> 
                    <button class="btncarinfo fw-bold"> edit my profile</button>
                </div>
            </div>                  
    </form>    
    </div>
