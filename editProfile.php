...
<html lang="en">
  ...
  <body>
    ...
    <form id="appointmentForm" action="handle/editProfileHandle.php" method="post">
            <div class="row">   
                <div class="secLeft col-12 col-lg-6 ">

                <div class="form-group">
                        <label for="name">First Name</label>
                        <input type="text" id="name" name="name" value="<?php echo $userInfo['name'] ?>"  class="form-control  border-black">
                </div>

                <div class="form-group">
                    <label for="Email">Email</label>
                    <input type="text" id="Email" name="Email" value="<?php echo $userInfo['email'] ?>"  class="form-control  border-black">
                </div>
                ...
                <div class="form-group d-flex justify-content-evenly py-5">
                    ...
                    <button type="submit" name="submit" class="btncarinfo fw-bold">Save</button>
                </div>
            </div>                  
    </form>    
    </div>
