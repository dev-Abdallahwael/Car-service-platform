    ...
    <!-- ============== NAVBAR ============== -->
      <nav class="navbar fixed-top bg-black navbar-expand-lg ">
        ...
        <div class="appointment-form mt-5 pt-5 container">
            ...
            <!-- form -->
        <form id="appointmentForm" action="handle/rentEditHandle.php?id=<?php echo $car['id'] ?>" method="post" enctype="multipart/form-data">
                <div class="row">   
                    ...
                    <div class="secRight col-12 col-lg-6 ">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="price" value="<?php echo $car['Price_per_day']; ?>" name="price" class="form-control"  required>
                        </div>
